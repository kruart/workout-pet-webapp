...
<body>
    ...
    <br><br><br>
    <div class="container">
        <a class="btn btn-primary" href="<c:url value="/exercise/create/workout/${wid}"/>"><spring:message code="message.addBtn"/></a>
        <table class="table">
            ...
            <c:forEach items="${exerciseList}" var="exercise" varStatus="theCount">
                <tr>
                    ...
                    <td><a href="<c:url value="/approach/all/exercise/${exercise.id}"/>">${exercise.description.name}</a></td>
                    ...
                    <td><a class="btn btn-warning" href="<c:url value="/exercise/update/${exercise.id}/workout/${wid}"/>"><spring:message code="message.editBtn"/></a></td>
                    <td><a class="btn btn-danger" href="<c:url value="/exercise/delete/${exercise.id}/workout/${wid}"/>"><spring:message code="message.deleteBtn"/></a></td>
                </tr>
            </c:forEach>
        </table>
    </div>
